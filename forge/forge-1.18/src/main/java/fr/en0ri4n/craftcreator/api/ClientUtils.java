...
import fr.en0ri4n.craftcreator.recipes.kubejs.KubeJSHelper;
...
import fr.en0ri4n.craftcreator.utils.CustomRunnable;
            ...
            if(ClientUtils.getCurrentScreen() instanceof RecipeManagerScreen)
            {
                ...
                switch(recipeList)
                {
                    case ADDED_RECIPES:
                        ...
                        screen.addToList(recipeList, new fr.en0ri4n.craftcreator.screen.widgets.SimpleListWidget.RecipeEntry(serializer.fromJson(id, jsonObject)));
                        break;
                    case MODIFIED_RECIPES:
                        screen.addToList(recipeList, new fr.en0ri4n.craftcreator.screen.widgets.SimpleListWidget.ModifiedRecipeEntry(KubeJSModifiedRecipe.deserialize(serializedRecipe)));
                        break;
                }
            }
        }));
